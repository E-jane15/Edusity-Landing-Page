  ...
  return (
    <div className='about'>
        ...
        <div className="about-right">
            ...
            <p>Embark on a transformative educational journeyy with our
                university's comprehensive education programs.Our cutting-edge curriculum is designed to empower students with the 
                knowledge, skills and experiences needed to excel in the dynamic 
               field of education.</p>
            <p>With afocus on innovation, hands-on learning, and personalized mentorship,
